...
@Component({
  selector: 'app-zad2832komponent1',
  templateUrl: './zad2832komponent1.component.html',
  styleUrls: ['./zad2832komponent1.component.scss']
})
export class Zad2832komponent1Component implements OnInit {
